    ...
    this.cards = [
...

      {
        ...
        fields: [
          ...
          { icon: "mdi-cloud-check-outline", key: "ENABLE_WEBDAV_SERVICE", label: "settings.enable_webdav_service", type: 'checkbox' },
          { icon: "mdi-cloud-sync-outline", key: "WEBDAV_SYNC_FOLDER", label: "settings.enable_webdav_sync", type: 'checkbox' },
